...
public final class StoredDataBreakConfirmScreen extends Screen {
    private final BlockPos pos;
    private final Identifier packetId;
    private final String warning;

    public StoredDataBreakConfirmScreen(BlockPos pos, Identifier packetId, String warning) {
        super(Text.literal("파괴 확인"));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(textRenderer, Text.literal(warning), width / 2, y + 40, 0xFFB8BCC0);
