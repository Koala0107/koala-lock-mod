...
public final class KeypadScreen extends HandledScreen<KeypadScreenHandler> {
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.literal("0"), button -> press(0))
                ...
                .build());
        addDrawableChild(ButtonWidget.builder(Text.translatable("screen.korime_scene.clear"), button -> {
                    input = "";
                    playKeySound(0.65F);
                ...
                .build());
        addDrawableChild(ButtonWidget.builder(Text.translatable("screen.korime_scene.confirm"), button -> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("screen.korime_scene.length_hint").formatted(Formatting.GRAY),
