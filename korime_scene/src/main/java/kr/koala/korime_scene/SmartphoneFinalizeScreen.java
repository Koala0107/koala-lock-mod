...
public final class SmartphoneFinalizeScreen extends Screen {
    ...
    protected void init() {
        ...
        titleField = addDrawableChild(new TextFieldWidget(textRenderer,
                ...
                Text.translatable("screen.korime_scene.smartphone.save.name")));
        titleField.setMaxLength(SmartphoneData.MAX_TITLE_LENGTH);
        titleField.setPlaceholder(Text.translatable("screen.korime_scene.smartphone.save.name_placeholder"));
        ...
        subtitleField = addDrawableChild(new TextFieldWidget(textRenderer,
                ...
                Text.translatable("screen.korime_scene.smartphone.save.subtitle")));
        ...
        subtitleField.setPlaceholder(Text.translatable("screen.korime_scene.smartphone.save.subtitle_placeholder")
        ...
        addDrawableChild(ButtonWidget.builder(
                        Text.translatable("screen.korime_scene.smartphone.save.cancel"),
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(textRenderer, Text.translatable("screen.korime_scene.smartphone.save.name"),
                panelX + 18, panelY + 32, 0xFF33383D, false);
        context.drawText(textRenderer, Text.translatable("screen.korime_scene.smartphone.save.subtitle"),
