...
public final class BoundaryLineMod implements ModInitializer {
    public static final Block HORIZONTAL = registerEdge("line_horizontal", "하얀선 가로", true);
    public static final Block VERTICAL = registerEdge("line_vertical", "하얀선 세로", false);
    ...
    private static Block register(String id, String displayName, Block block) {
        Registry.register(Registries.BLOCK, new Identifier(KorimeSceneMod.MOD_ID, id), block);
        Registry.register(
                Registries.ITEM,
                new Identifier(KorimeSceneMod.MOD_ID, id),
    ...
    public void onInitialize() {
        ItemGroupEvents.modifyEntriesEvent(RegistryKey.of(
                ...
                new Identifier(KorimeSceneMod.MOD_ID, "korime_scene")
        )).register(entries -> {
